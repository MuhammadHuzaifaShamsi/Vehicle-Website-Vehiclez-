...
<head>
    ...
    <title>Contact Us | <?php echo $settings_r['site_title'] ?></title>
</head>
                ...
                <div class="bg-white rounded shadow p-4">
                    <form method="post">
                        ...
                        <div class="mt-3">
                            ...
                            <textarea name="message" required style="resize: none;" rows="5" name="" class="form-control shadow-none"></textarea>
                        </div>
                        <button name="send" type="submit" class="btn text-white mt-3 custom-bg">SEND</button>
                    </form>
                </div>
            </div>
        </div>
