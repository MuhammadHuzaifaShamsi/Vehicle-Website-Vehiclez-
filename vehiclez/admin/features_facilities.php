...
<head>
    ...
    <title>Admin Panel - Features & Facilities | <?php echo $settings_r['site_title'] ?></title>
                ...
                <div class="card border-0 shadow-sm mb-3">
                    <div class="card-body">
                        ...
                        <div class="d-flex align-items-center justify-content-between mb-3">
                            <h5 class="card-title m-0 fw-bold">Features</h5>
            ...
            <form id="facility_s_form">
                ...
                <div class="modal-body">
                    ...
                    <div class="mb-3">
                        ...
                        <span class="badge rounded-pill bg-light text-dark text-wrap lh-base">Only SVG format allowed!</span>
                        <input type="file" name="facility_icon" accept=".svg" required class="form-control shadow-none">
                    </div>
                    <div class="mb-3">
                        <label class="form-label fw-bold">Description</label>
                        <textarea name="facility_des" rows="3" class="form-control shadow-none"></textarea>
                    </div>
                </div>
                <div class="modal-footer">
                    <button type="reset" class="btn text-secondary shadow-none" data-bs-dismiss="modal">Cancel</button>
